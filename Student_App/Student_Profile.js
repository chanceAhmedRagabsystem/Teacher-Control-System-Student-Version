...
export default class Student_Profile extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <>
                ...
                <ScrollView style={{ flex: 1, backgroundColor: Background }}>
                    <View style={{ width: 90, height: 90, alignSelf: 'center', borderRadius: 5, justifyContent: 'center', borderWidth: .2, borderColor: '#000', marginTop: 10 }}>
                        ...
                        <Image source={require('../images/user.png')} style={{ width: 60, height: 60, alignSelf: 'center', borderRadius: 10 }}
                            resizeMode='stretch'
                        />
                    ...
                    <View style={styles.bodyContainer}>
                        ...
                        <View
                            ...
                            <Text style={{ color: '#1D1D1D', fontSize: 17, marginRight: 10, alignSelf: 'center' }}>
                        ...
                        <View
                            style={[styles.contianerOfInfo, { flexDirection: 'row' }]}>
                            <Text style={{ color: '#1D1D1D', fontSize: 17 }}>{this.state.data.student_grade}</Text>
                        ...
                        <View
                            style={[styles.contianerOfInfo, { flexDirection: 'row' }]}>
                            <Text style={{ color: '#1D1D1D', fontSize: 17 }}>{this.state.data.student_group}</Text>
                            ...
                            <TouchableOpacity style={{ justifyContent: 'center' }}
                                onPress={() => {
                                    Alert.alert('تحذير', 'هل تريد تسجيل الخروج', [
                                        ...
                                        { text: 'لا', onPress: () => this.props.navigation.navigate('Student_Profile') }])
                                }}
                            >
                                    ...
                                    onChangeText={value => {
                                        this.setState({
                                            data: {
                                                ...
                                                student_grade: this.state.data.student_grade,
                                                student_group: this.state.data.student_group,
                                            },
                            ...
                            <View
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        axios
                                            .post(
                                                'http://192.168.1.5/AhmedRagab_System/edit_studentData.php',
                                                {
                                                    user_id: this.state.data.user_id,
